...
var styles = {
	...
	android: {
		color: {
			resource_paths: [
				"?attr/secondarySystemBackground"
			]
		}
	},
	"default": {
	...
	android: {
		color: {
			resource_paths: [
				"?attr/secondarySystemGroupedBackground"
			]
		}
	},
	"default": {
	...
	android: {
		color: {
			resource_paths: [
				"?attr/tertiarySystemGroupedBackground"
			]
		}
	},
	"default": {
...
function createTransitionFns(variantFn) {
  function useTransition(classNames = "", variantValue, animatedConfig = {}) {
    ...
    const animatedValue = React__default['default'].useRef(new reactNative.Animated.Value(0)).current;
